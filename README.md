## Welcome
Here you can find various projects that surve to simplify our being.<br>

### Projects by groups:
- #### Artificial Inteliegence (AI)
    - [aiJS](https://github.com/yepiiik/aiJS)
- #### API usage:
    - [tiktok_music](https://github.com/yepiiik/tiktokapi)
    - [youtube_captions](https://github.com/yepiiik/videolang)
